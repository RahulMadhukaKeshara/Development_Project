                ...
                <Form className='add_product_category_form' onSubmit={(e) => handleSubmit(e)} type='submit'>
                    ...
                    <Form.Row>
                        ...
                        <Form.Group  controlId="supplier_Contact">
                            ...
                            <Form.Control className='add_product_category_form_input' maxLength="10" required onChange={(e) => handleChange(e)}  value={data.supplier_Contact} type="tel" pattern="[0-9]{10}" placeholder="07********" />
                        </Form.Group>
                        </Col>
                    </Form.Row>
